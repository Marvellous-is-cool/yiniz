 ...
 * UPDATED: Requires password for all connections
 */
...
/**
 * Local MySQL server - NOW REQUIRES PASSWORD
 */
$i++;
...
$cfg['Servers'][$i]['AllowNoPassword'] = false;  // CHANGED: Now requires password
$cfg['Servers'][$i]['verbose'] = 'Local MySQL (Development) - Password Required';
